            ...
            for (const file of imageFiles) {
                try {
                    ...
                    artwork.official.push({
                        ...
                        author: author,
                        filename: file,
                        path: `https://raw.githubusercontent.com/aaronmaynard/Chronicles-Of-Max/main/artwork/official/${encodeURIComponent(file)}`,
                        fileSize: stats.size,
            ...
            for (const file of imageFiles) {
                try {
                    ...
                    artwork.fanart.push({
                        ...
                        author: author,
                        filename: file,
                        path: `https://raw.githubusercontent.com/aaronmaynard/Chronicles-Of-Max/main/artwork/fanart/${encodeURIComponent(file)}`,
                        fileSize: stats.size,
                        lastModified: stats.mtime.toISOString(),
                        date: stats.mtime.toISOString(),
                        category: 'fanart'
